            ...
            if (!function_exists('bd_remove_footer_admin')) {
                ...
                function bd_remove_footer_admin() {
                    ...
                    <p id="footer-left" class="alignleft">
                        ...
                        <a href="https://www.solwininfotech.com/product/wordpress-plugins/blog-designer/" target="_blank"><strong><?php _e('Blog Designer', 'blog-designer'); ?></strong></a>
                            ...
                            <?php if (get_option('rss_use_excerpt') == 1): ?>
                                <div class="read_more">
                                    ...
                                    if (get_option('read_more_text') != '') {
                                        ...
                                        echo ' <a class="more-tag" href="' . get_permalink($post->ID) . '"><i class="fa fa-plus"></i> ' . __('Read more &raquo;', 'blog-designer') . '</a>';
                                    }
                                    ?>
                                </div>
                            <?php endif; ?>
    ...
    function wp_blog_designer_menu_function() {
        ...
        <div class="wrap">
            ...
            <div class="updated notice notice-success" id="message">
                <p><?php _e('Blog Designer', 'blog-designer'); ?> : <a href="https://www.solwininfotech.com/documents/wordpress/blogdesigner-lite" target="_blank"><?php _e('Live Documentation', 'blog-designer'); ?></a> <?php _e('and', 'blog-designer'); ?> <a href="http://blogdesigner.solwininfotech.com" target="blank"><?php _e('Live Demo', 'blog-designer'); ?></a></p>
                <p><?php _e('Want more blog designer support for all type of archive pages, single post page and much more?', 'blog-designer'); ?> <b><a href="https://codecanyon.net/item/blog-designer-pro-for-wordpress/17069678?ref=solwin" target="blank"><?php _e('Upgrade to PRO', 'blog-designer'); ?></a></b></p>
            </div>
            <?php
                                        ...
                                        <td>
                                            <div class="select-cover">
                                                <select name="template_name" id="template_name">
                                                    <option value=""><?php echo '-- '; _e('Select Blog Template', 'blog-designer'); echo ' --'; ?></option>
                ...
                <div class="bd-support">
                    ...
                    <div class="help-wrapper">
                        <span><?php _e('Check out the', 'blog-designer') ?>
                            <a href="https://wordpress.org/plugins/blog-designer/faq/" target="_blank"><?php _e('FAQs', 'blog-designer'); ?></a>
                            <?php _e('and', 'blog-designer') ?>
                            <a href="https://wordpress.org/support/plugin/blog-designer" target="_blank"><?php _e('Support Forums', 'blog-designer') ?></a>
                        </span>
                    </div>
                </div>
                <div class="bd-support">
...
if (!function_exists('designer_pagination')) {
    ...
    function designer_pagination($args = array()) {
        ...
        $links = paginate_links(array(
            ...
            'prev_text' => __('&larr; Previous', 'blog-designer'),
            'next_text' => __('Next &rarr;', 'blog-designer'),
            'type' => 'list',
        ));
